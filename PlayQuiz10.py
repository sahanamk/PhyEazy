...
def PlayQuiz():
     with ( open("Quiz10.txt", "rb")) as log_file:
            while True:
                 try:
...
def ProcessQuest():  
     ...
     if count[0] !=0 :
          ...
          D.destroy()
          cor=Label(tk,text='\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t',bg='#ffecad',width=30,font=("plasma  Brk",20,'bold'),fg='#00ad7f').place(x=-50, y=600, anchor = W)
          qe=Label(tk,text='\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t',bg='#ffecad',width=500,font=("plasma  Brk",20,'bold'),fg='#00ad7f').place(x=50, y=150, anchor = W)
          ...
          def Back7():
               tk.destroy()
          back=Button(tk, text='Back to Class 10',font=("plasma  Brk",20,'bold'),fg='#00ad7f', width = 30,command = Back7)
          back.pack()
...
Que=Label(tk,textvariable=Q,bg='#ffecad',width=100,font=("plasma  Brk",20,'bold'),fg='#00ad7f').place(x=50, y=150, anchor = W)
